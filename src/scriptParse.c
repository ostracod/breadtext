...
scriptBuiltInFunction_t scriptBuiltInFunctionSet[] = {
    ...
    {{SCRIPT_FUNCTION_TYPE_BUILT_IN, 1}, (int8_t *)"fileExists", SCRIPT_FUNCTION_FILE_EXISTS},
    {{SCRIPT_FUNCTION_TYPE_BUILT_IN, 1}, (int8_t *)"openFile", SCRIPT_FUNCTION_OPEN_FILE},
    {{SCRIPT_FUNCTION_TYPE_BUILT_IN, 1}, (int8_t *)"getFileSize", SCRIPT_FUNCTION_GET_FILE_SIZE},
    {{SCRIPT_FUNCTION_TYPE_BUILT_IN, 2}, (int8_t *)"setFileSize", SCRIPT_FUNCTION_SET_FILE_SIZE},
    {{SCRIPT_FUNCTION_TYPE_BUILT_IN, 2}, (int8_t *)"readFile", SCRIPT_FUNCTION_READ_FILE},
    {{SCRIPT_FUNCTION_TYPE_BUILT_IN, 2}, (int8_t *)"writeFile", SCRIPT_FUNCTION_WRITE_FILE},
    {{SCRIPT_FUNCTION_TYPE_BUILT_IN, 1}, (int8_t *)"getFileOffset", SCRIPT_FUNCTION_GET_FILE_OFFSET},
    {{SCRIPT_FUNCTION_TYPE_BUILT_IN, 2}, (int8_t *)"setFileOffset", SCRIPT_FUNCTION_SET_FILE_OFFSET},
    {{SCRIPT_FUNCTION_TYPE_BUILT_IN, 1}, (int8_t *)"closeFile", SCRIPT_FUNCTION_CLOSE_FILE},
    {{SCRIPT_FUNCTION_TYPE_BUILT_IN, 1}, (int8_t *)"deleteFile", SCRIPT_FUNCTION_DELETE_FILE},
    {{SCRIPT_FUNCTION_TYPE_BUILT_IN, 1}, (int8_t *)"printToConsole", SCRIPT_FUNCTION_PRINT_TO_CONSOLE},
    {{SCRIPT_FUNCTION_TYPE_BUILT_IN, 0}, (int8_t *)"promptFromConsole", SCRIPT_FUNCTION_PROMPT_FROM_CONSOLE},
    {{SCRIPT_FUNCTION_TYPE_BUILT_IN, 1}, (int8_t *)"pressKey", SCRIPT_FUNCTION_PRESS_KEY},
    {{SCRIPT_FUNCTION_TYPE_BUILT_IN, 1}, (int8_t *)"pressKeys", SCRIPT_FUNCTION_PRESS_KEYS},
