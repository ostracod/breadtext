...
scriptOperator_t scriptOperatorSet[] = {
    ...
    {(int8_t *)"-", SCRIPT_OPERATOR_NEGATE, SCRIPT_OPERATOR_TYPE_UNARY_PREFIX, 0},
    ...
    {(int8_t *)"!", SCRIPT_OPERATOR_BOOLEAN_NOT, SCRIPT_OPERATOR_TYPE_UNARY_PREFIX, 0},
    ...
    {(int8_t *)"~", SCRIPT_OPERATOR_BITWISE_NOT, SCRIPT_OPERATOR_TYPE_UNARY_PREFIX, 0},
    ...
    {(int8_t *)"++", SCRIPT_OPERATOR_INCREMENT_PREFIX, SCRIPT_OPERATOR_TYPE_UNARY_PREFIX, 0},
    {(int8_t *)"++", SCRIPT_OPERATOR_INCREMENT_POSTFIX, SCRIPT_OPERATOR_TYPE_UNARY_POSTFIX, 0},
    {(int8_t *)"--", SCRIPT_OPERATOR_DECREMENT_PREFIX, SCRIPT_OPERATOR_TYPE_UNARY_PREFIX, 0},
    {(int8_t *)"--", SCRIPT_OPERATOR_DECREMENT_POSTFIX, SCRIPT_OPERATOR_TYPE_UNARY_POSTFIX, 0}
};
