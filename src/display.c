...
int8_t *helpText[] = {
    ...
    (int8_t *)"Y = Select until end of word",
    (int8_t *)"Shift + Y = Select until beginning of word",
    (int8_t *)"Shift + 0 = Select until end of line",
    (int8_t *)"Shift + 9 = Select until beginning of line",
    ...
    (int8_t *)"Shift + ` = Move cursor to visible text",
    (int8_t *)"<> = Go to previous or next word",
    (int8_t *)"90 = Go to beginning or end of word",
    (int8_t *)"[] = Go to beginning or end of line",
    (int8_t *)"{} = Go to beginning or end of file",
    (int8_t *)"= = Go to end of indentation",
    (int8_t *)"8 = Go to matching delimiter",
    ...
    (int8_t *)"N = Find next instance of search term",
    (int8_t *)"Shift + N = Find previous instance of search term",
    ...
    (int8_t *)"",
    (int8_t *)"Tab = Indent",
    (int8_t *)"Shift + Tab = Remove indentation",
    ...
    (int8_t *)"statusBarBackgroundColor 5"
};
