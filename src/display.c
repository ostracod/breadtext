...
int8_t *helpText[] = {
    ...
    (int8_t *)"9 = Delete until beginning of line exclusive",
    (int8_t *)"Shift + 9 = Delete until beginning of line inclusive",
    (int8_t *)"0 = Delete until end of line exclusive",
    (int8_t *)"Shift + 0 = Delete until end of line inclusive",
